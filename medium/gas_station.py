...
class Solution:
    """
    Check that solution exists by comparing sum of gas and cost. Then use greedy
    algorithm to find the start position.
    Time: O(n)
    Space: O(1)
    """
...
def test_complete_circuit(gas, cost, expected_output):
