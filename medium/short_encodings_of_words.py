...
class Solution:
    ...
    K - total amount of characters in the words
    """
...
@pytest.mark.parametrize(
    "words,expected_answer", (
        (["time", "me", "bell"], 10),
        (["t"], 2),
    )
)
def test_min_len_encoding(words, expected_answer):
    assert Solution().minimumLengthEncoding(words) == expected_answer
